    ...
    <header className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
      ...
      <div className='w-full flex justify-between items-center lg:hidden'>
        <nav>
          ...
          <CustomLink href="/socios" title="Socios" className='mx-4' />
          {/* <CustomLink href="/academiaTrading" title="Academia Trading" className='mx-4' />
          <CustomLink href="/inversor" title="Inversores" className='ml-4' /> */}
        </nav>
      ...
      -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32'>
            <nav className='flex items-center flex-col justify-center'>
              ...
              <CustomMobileLink href="/socios" title="Socios" className='' toggle={handleClick} />
              {/* <CustomMobileLink href="/academiaTrading" title="Academia Trading" className='' toggle={handleClick} />
              <CustomMobileLink href="/inversor" title="Inversores" className='' toggle={handleClick} /> */}
            </nav>
            <nav className='flex items-center justify-center flex-wrap mt-2'>
              <Link href="/" target={"_blank"} className='w-6 mr-3 sm:mx-1'>
                <LinkedInIcon />
              </Link>
              <Link href="/" target={"_blank"} className='w-6 mr-3 sm:mx-1'>
                <TwitterIcon />
